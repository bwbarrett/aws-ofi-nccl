...
/* use GCC macro statement expressions to check and abort on error.
 * We use a macro instead of an inline function so that the function
 * printed in the NCCL_OFI_WARN call is the function in which the
 * error occurred.
 */
